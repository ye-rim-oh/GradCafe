...
| 파일                                 | 설명                                                                                                                                                                                       |
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `scrape_all_years.R`                 | 2020~2026 시즌을 같은 파서 규칙으로 수집하는 통합 크롤러입니다. 키워드 검색, 중복 제거, PhD 필터, 서브필드 태깅까지 포함합니다.                                                           |
...
- **최신 갱신일**: 2026년 3월 4일 재수집 기준이며, 통합 표본은 5,139건(2026 시즌 1,098건)입니다.
